...
export default class DonutChart extends Component {
    ...
    async componentDidMount() {
        ...
        const urlPolarity = 'http://127.0.0.1:8000/api/polarity?obj='+ dataMessages;
        ...
        <div>
            {
                ...
                :
                <div>
                     <Doughnut width={300} height={300} options={{ maintainAspectRatio: false }} data={this.state.data}></Doughnut>
                </div>
